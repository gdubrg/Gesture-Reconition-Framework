...

{
   ...
   // m_frameHelper.SetNuiInitFlags(true,true,true,true);
   // m_frameHelper.SetColorFrameResolution(NUI_IMAGE_RESOLUTION_640x480);
    //m_frameHelper.SetDepthFrameResolution(NUI_IMAGE_RESOLUTION_320x240);
    ...
    {
        cout << "Kinect non connected. ERROR!" << endl;
