...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        groupSource->setGeometry(QRect(90, 50, 441, 381));
        QFont font;
        ...
        label_6->setGeometry(QRect(60, 120, 91, 31));
        ...
        label_8->setGeometry(QRect(180, 120, 141, 41));
        label_9 = new QLabel(groupSource);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(70, 190, 64, 64));
        label_9->setPixmap(QPixmap(QString::fromUtf8("Images/folder-128.png")));
        label_9->setScaledContents(true);
        label_10 = new QLabel(groupSource);
        label_10->setObjectName(QStringLiteral("label_10"));
        label_10->setGeometry(QRect(180, 200, 141, 41));
        radioButton = new QRadioButton(groupSource);
        radioButton->setObjectName(QStringLiteral("radioButton"));
        radioButton->setGeometry(QRect(30, 285, 82, 17));
        label_11 = new QLabel(groupSource);
        label_11->setObjectName(QStringLiteral("label_11"));
        label_11->setGeometry(QRect(180, 270, 141, 41));
        groupMethod = new QGroupBox(widgetR);
        groupMethod->setObjectName(QStringLiteral("groupMethod"));
        groupMethod->setGeometry(QRect(570, 50, 421, 381));
        ...
        buttonStart->setGeometry(QRect(510, 470, 91, 41));
...
""));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        radioButton->setText(QApplication::translate("MainWindow", "...", 0));
        label_11->setText(QApplication::translate("MainWindow", "Work in progress", 0));
